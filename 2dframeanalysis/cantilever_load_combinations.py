...
beam.add_member_dist_load('M1', 'Fy', -1000, -1000, 0, 10,case='Dead')
beam.add_member_dist_load('M1', 'Fy', -1000, -1000, 0, 10,case='Live')
beam.add_load_combo('610b', {'Dead':1.4,'Live':1.6},combo_tags=['ULS'])
beam.add_load_combo('1*D+1*L', {'Dead':1.0,'Live':1.0},combo_tags=['SLS Characteristic'])
